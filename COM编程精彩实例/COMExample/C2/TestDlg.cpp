...
#import "server\server.tlb" no_namespace // don't need to use a SERVERLib:: scope in
										// front of every IWzdPtr, etc.
...
{
//////////////////////////////////////////////////////////////////////////
//////////     CREATE THE COM OBJECT IN CONSTRUCTOR   ///////////////////////////
//////////////////////////////////////////////////////////////////////////

	// create in constructor (must catch any COM error)
	try
	{
		IWzdPtr pPtr1(
...
//////////////////////////////////////////////////////////////////////////
////////////     CREATE THE COM OBJECT IN A METHOD CALL   ///////////////////////////
//////////////////////////////////////////////////////////////////////////
	// create in CreateInstance() method of smart pointer class
	IWzdPtr pPtr2;
