...
//////////////////////////////////////////////////////////////////////////
	...
	HRESULT hr=::CoCreateInstance(
				...
				(LPVOID*) &iWzd1);	// returned object pointer
	if (FAILED(hr))
	{
		_com_error err(hr);
...
//////////////////////////////////////////////////////////////////////////
////////////////     CREATE THE COM OBJECT AGAIN   ///////////////////////////
//////////////////////////////////////////////////////////////////////////
// gets pointer to same COM object
	IWzd *iWzd2=NULL;
	hr=::CoCreateInstance(
				CLSID_IWzdSrv,		// name of dll to load
				NULL,				// aggregated COM object (none)
				CLSCTX_INPROC_SERVER,// use dll
				IID_IWzd,			// class to create and object of
				(LPVOID*) &iWzd2);	// returned object pointer
	if (FAILED(hr))
	{
		_com_error err(hr);
		AfxMessageBox(err.ErrorMessage());
...
//////////////////////////////////////////////////////////////////////////
	long lArg;
	iWzd1->Method1(9876,&lArg);
	iWzd2->Method1(3214,&lArg);
