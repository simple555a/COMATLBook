...
/* at Mon Feb 21 12:32:09 2000
 */
/* Compiler settings for C:\_jeswanke\mfc3\Examples\C34\Server\Server.idl:
...
EXTERN_C const IID IID_IWzd;
    ...
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE GetCollection( 
            /* [out] */ LPUNKNOWN __RPC_FAR *iCollection) = 0;
    ...
    typedef struct IWzdVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetCollection )( 
            IWzd __RPC_FAR * This,
            /* [out] */ LPUNKNOWN __RPC_FAR *iCollection);
...
#define IWzd_GetCollection(This,iCollection)	\
    (This)->lpVtbl -> GetCollection(This,iCollection)
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IWzd_GetCollection_Proxy( 
    IWzd __RPC_FAR * This,
    /* [out] */ LPUNKNOWN __RPC_FAR *iCollection);


void __RPC_STUB IWzd_GetCollection_Stub(
    IRpcStubBuffer *This,
