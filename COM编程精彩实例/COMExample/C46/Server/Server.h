...
/* at Mon Feb 21 12:48:39 2000
 */
/* Compiler settings for C:\_jeswanke\mfc3\Examples\C46\Server\Server.idl:
...
EXTERN_C const IID IID_IWzd;
    ...
    MIDL_INTERFACE("351495D0-AA6D-11D3-807E-000000000000")
    IWzd : public IDispatch
    {
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Method1( 
            /* [in] */ long lArg,
            /* [retval][out] */ long __RPC_FAR *plArg) = 0;
    ...
    typedef struct IWzdVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Method1 )( 
            IWzd __RPC_FAR * This,
            /* [in] */ long lArg,
            /* [retval][out] */ long __RPC_FAR *plArg);
...
#define IWzd_Method1(This,lArg,plArg)	\
    (This)->lpVtbl -> Method1(This,lArg,plArg)

#define IWzd_Method2(This,lArg)	\
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IWzd_Method2_Proxy( 
    IWzd __RPC_FAR * This,
    /* [in] */ long lArg);
