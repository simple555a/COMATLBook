...
//////////////////////////////////////////////////////////////////////////
	...
	// using smart pointer wrapper causes COM failures to be thrown
	try
	{
	...
	// using the raw pointer prevents COM failures from being thrown
	// (you can also prevent methods from being wrapped with a keyword in #import statement)
	hr=pPtr->raw_Method1(1234,&retval);

	// retrieve IErrorInfo
	hr=pPtr->raw_Method2(4321);
