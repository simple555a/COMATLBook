...
/* at Mon Feb 21 12:31:27 2000
 */
/* Compiler settings for C:\_jeswanke\mfc3\Examples\C33\Server\Server.idl:
...
#define IWzd_Simple1(This,cArg,sArg,lArg)	\
    (This)->lpVtbl -> Simple1(This,cArg,sArg,lArg)

#define IWzd_Simple2(This,fArg,dArg)	\
    (This)->lpVtbl -> Simple2(This,fArg,dArg)

#define IWzd_VBVars1(This,pBSTR)	\
    (This)->lpVtbl -> VBVars1(This,pBSTR)
