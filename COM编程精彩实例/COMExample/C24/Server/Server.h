...
/* at Mon Feb 21 11:53:18 2000
 */
/* Compiler settings for C:\_jeswanke\mfc3\Examples\C24\Server\Server.idl:
...
#ifndef __IWzdTear_FWD_DEFINED__
#define __IWzdTear_FWD_DEFINED__
typedef interface IWzdTear IWzdTear;
#endif 	/* __IWzdTear_FWD_DEFINED__ */
...
#ifndef __IWzdTear_INTERFACE_DEFINED__
#define __IWzdTear_INTERFACE_DEFINED__

/* interface IWzdTear */
/* [unique][helpstring][dual][uuid][object] */ 


EXTERN_C const IID IID_IWzdTear;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("C177118E-9AAA-11D3-805D-000000000000")
    IWzdTear : public IDispatch
    {
    public:
    ...
    typedef struct IWzdTearVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IWzdTear __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
    ...
    interface IWzdTear
    {
        CONST_VTBL struct IWzdTearVtbl __RPC_FAR *lpVtbl;
    };
...
#define IWzdTear_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define IWzdTear_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define IWzdTear_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define IWzdTear_GetTypeInfoCount(This,pctinfo)	\
    (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo)

#define IWzdTear_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo)

#define IWzdTear_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)

#define IWzdTear_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)


#define IWzdTear_Method2(This,lArg)	\
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IWzdTear_Method2_Proxy( 
    IWzdTear __RPC_FAR * This,
    /* [in] */ long lArg);


void __RPC_STUB IWzdTear_Method2_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#endif 	/* __IWzdTear_INTERFACE_DEFINED__ */
