...
EXTERN_C const IID IID_IWzd;
    ...
    MIDL_INTERFACE("754715CC-AB1E-11D3-8080-000000000000")
    ...
    typedef struct IWzdVtbl
    {
        ...
        /* [helpstring][id][propget] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *get_Property1 )( 
            IWzd __RPC_FAR * This,
            /* [retval][out] */ long __RPC_FAR *pVal);
        
        /* [helpstring][id][propput] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *put_Property1 )( 
            IWzd __RPC_FAR * This,
            /* [in] */ long newVal);
...
#define IWzd_get_Property1(This,pVal)	\
    (This)->lpVtbl -> get_Property1(This,pVal)

#define IWzd_put_Property1(This,newVal)	\
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IWzd_get_Property1_Proxy( 
    IWzd __RPC_FAR * This,
    /* [retval][out] */ long __RPC_FAR *pVal);


void __RPC_STUB IWzd_get_Property1_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE IWzd_put_Property1_Proxy( 
    IWzd __RPC_FAR * This,
    /* [in] */ long newVal);


void __RPC_STUB IWzd_put_Property1_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
