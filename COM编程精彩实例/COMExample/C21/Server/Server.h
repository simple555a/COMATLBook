...
/* at Mon Feb 21 11:48:41 2000
 */
/* Compiler settings for C:\_jeswanke\mfc3\Examples\C21\Server\Server.idl:
...
#ifndef __IWzdEx_FWD_DEFINED__
#define __IWzdEx_FWD_DEFINED__
typedef interface IWzdEx IWzdEx;
#endif 	/* __IWzdEx_FWD_DEFINED__ */
...
#ifndef __WzdEx_FWD_DEFINED__
#define __WzdEx_FWD_DEFINED__

#ifdef __cplusplus
typedef class WzdEx WzdEx;
#else
typedef struct WzdEx WzdEx;
#endif /* __cplusplus */

#endif 	/* __WzdEx_FWD_DEFINED__ */
...
EXTERN_C const IID IID_IWzd;
    ...
    MIDL_INTERFACE("4832AAD4-AB3F-11D3-8081-000000000000")
...
#ifndef __IWzdEx_INTERFACE_DEFINED__
#define __IWzdEx_INTERFACE_DEFINED__

/* interface IWzdEx */
/* [unique][helpstring][dual][uuid][object] */ 


EXTERN_C const IID IID_IWzdEx;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("4832AAD5-AB3F-11D3-8081-000000000000")
    IWzdEx : public IDispatch
    {
    public:
    ...
    typedef struct IWzdExVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IWzdEx __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
    ...
    interface IWzdEx
    {
        CONST_VTBL struct IWzdExVtbl __RPC_FAR *lpVtbl;
    };
...
#define IWzdEx_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define IWzdEx_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define IWzdEx_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define IWzdEx_GetTypeInfoCount(This,pctinfo)	\
    (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo)

#define IWzdEx_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo)

#define IWzdEx_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)

#define IWzdEx_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)


#define IWzdEx_Method2(This,lArg)	\
    (This)->lpVtbl -> Method2(This,lArg)
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IWzdEx_Method2_Proxy( 
    IWzdEx __RPC_FAR * This,
    /* [in] */ long lArg);


void __RPC_STUB IWzdEx_Method2_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
#endif 	/* __IWzdEx_INTERFACE_DEFINED__ */
...
EXTERN_C const CLSID CLSID_WzdEx;

#ifdef __cplusplus

class DECLSPEC_UUID("4832AAD6-AB3F-11D3-8081-000000000000")
WzdEx;
#endif
