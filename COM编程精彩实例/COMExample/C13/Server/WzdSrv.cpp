...
BEGIN_INTERFACE_MAP(CWzdSrv, CCmdTarget)
	...
	INTERFACE_PART(CWzdSrv, IID_IWzd, WzdClass) 		// add this line for custom interface
    INTERFACE_PART(CWzdSrv, IID_IConnectionPointContainer, ConnPtContainer) // add this line to support connection points
END_INTERFACE_MAP()
