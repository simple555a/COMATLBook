...
!MESSAGE "Server - Win32 Release MinSize" (based on "Win32 (x86) Application")
!MESSAGE "Server - Win32 Release MinDependency" (based on "Win32 (x86) Application")
!MESSAGE "Server - Win32 Unicode Release MinSize" (based on "Win32 (x86) Application")
!MESSAGE "Server - Win32 Unicode Release MinDependency" (based on "Win32 (x86) Application")
!MESSAGE 
...
OutDir=.\Debug
TargetPath=.\Debug\Server.exe
InputPath=.\Debug\Server.exe
SOURCE="$(InputPath)"
...
# Begin Custom Build - Performing registration
OutDir=.\DebugU
TargetPath=.\DebugU\Server.exe
InputPath=.\DebugU\Server.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinSize\Server.exe
InputPath=.\ReleaseMinSize\Server.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinDependency\Server.exe
InputPath=.\ReleaseMinDependency\Server.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseUMinSize\Server.exe
InputPath=.\ReleaseUMinSize\Server.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseUMinDependency\Server.exe
InputPath=.\ReleaseUMinDependency\Server.exe
SOURCE="$(InputPath)"
