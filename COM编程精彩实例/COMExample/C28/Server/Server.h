...
/* at Mon Feb 21 11:58:48 2000
 */
/* Compiler settings for C:\_jeswanke\mfc3\Examples\C28\Server\Server.idl:
...
#ifndef ___IWzdEvents_FWD_DEFINED__
#define ___IWzdEvents_FWD_DEFINED__
typedef interface _IWzdEvents _IWzdEvents;
#endif 	/* ___IWzdEvents_FWD_DEFINED__ */
...
EXTERN_C const IID IID_IWzd;
    ...
    MIDL_INTERFACE("603F1DE4-A7D8-11D3-A398-00C04F570E2C")
...
#ifndef ___IWzdEvents_DISPINTERFACE_DEFINED__
#define ___IWzdEvents_DISPINTERFACE_DEFINED__

/* dispinterface _IWzdEvents */
/* [helpstring][uuid] */ 


EXTERN_C const IID DIID__IWzdEvents;

#if defined(__cplusplus) && !defined(CINTERFACE)

    MIDL_INTERFACE("603F1DE5-A7D8-11D3-A398-00C04F570E2C")
    _IWzdEvents : public IDispatch
    {
    };
    
#else 	/* C style interface */

    typedef struct _IWzdEventsVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            _IWzdEvents __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
    ...
    interface _IWzdEvents
    {
        CONST_VTBL struct _IWzdEventsVtbl __RPC_FAR *lpVtbl;
    };
...
#define _IWzdEvents_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define _IWzdEvents_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define _IWzdEvents_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define _IWzdEvents_GetTypeInfoCount(This,pctinfo)	\
    (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo)

#define _IWzdEvents_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo)

#define _IWzdEvents_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)

#define _IWzdEvents_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)
...
#endif 	/* ___IWzdEvents_DISPINTERFACE_DEFINED__ */
...
class DECLSPEC_UUID("37D9335D-A706-11D3-A398-00C04F570E2C")
Wzd;
#endif
