...
public class Wzd implements IUnknown,com.ms.com.NoAutoScripting,server.IWzd
{
  ...
  public native void Simple3(int lArg1, int[] lArg2, int[] lArg3);
  ...
  public native void Array1(int lFirst, int lLast, int lSize, int[] aArg);
  ...
  public native void Array2(int lFirst, int lLength, int lSize, int[] aArg);
  ...
  public native void VBVars1(String bstr, String[] pBSTR);
  ...
  public native void VBVars2(com.ms.com.SafeArray pSA);
  ...
  public native void VBVars3(Variant pVAR1, Variant pVAR2, Variant pVAR3);

  /** @com.method(vtoffset=12, dispid=9, type=METHOD, name="VBVars4", addFlagsVtable=4)
      @com.parameters([type=I4] return) */
  public native int VBVars4();
