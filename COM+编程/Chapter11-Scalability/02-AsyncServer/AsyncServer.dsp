...
OutDir=.\Debug
TargetPath=.\Debug\AsyncServer.exe
InputPath=.\Debug\AsyncServer.exe
SOURCE="$(InputPath)"
...
"$(OutDir)\regsvr32.trg" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	...
	nmake -f AsyncServerPS.mk 
	regsvr32.exe AsyncServerPS.DLL 
...
SOURCE=.\AsyncServer.idl
# ADD MTL /tlb ".\AsyncServer.tlb" /h "AsyncServer.h" /iid "AsyncServer_i.c" /Oicf
# End Source File
# Begin Source File
